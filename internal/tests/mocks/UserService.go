...
func (_m *UserService) CreateUser(email string, password string) (*domain.User, error) {
...
func (_m *UserService) LoginUser(email string, password string) (*repository.LoginResponse, error) {
	ret := _m.Called(email, password)
...
func (_m *UserService) ReadUser(id string) (*domain.User, error) {
	ret := _m.Called(id)
...
func (_m *UserService) ReadUsers() ([]*domain.User, error) {
	ret := _m.Called()
...
func (_m *UserService) UpdateMembershipStatus(id string, status bool) error {
...
func (_m *UserService) UpdateUser(id string, email string, password string) error {
