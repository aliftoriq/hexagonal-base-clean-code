...
// MessengerRepository is an autogenerated mock type for the MessengerRepository type
type MessengerRepository struct {
	mock.Mock
}

// CreateMessage provides a mock function with given fields: userID, message
func (_m *MessengerRepository) CreateMessage(userID string, message domain.Message) error {
...
func (_m *MessengerRepository) DeleteMessage(id string) error {
	ret := _m.Called(id)
...
func (_m *MessengerRepository) ReadMessage(id string) (*domain.Message, error) {
	ret := _m.Called(id)
...
func (_m *MessengerRepository) ReadMessages() ([]*domain.Message, error) {
	ret := _m.Called()
...
func (_m *MessengerRepository) UpdateMessage(id string, message domain.Message) error {
...
// NewMessengerRepository creates a new instance of MessengerRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMessengerRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *MessengerRepository {
	mock := &MessengerRepository{}
	mock.Mock.Test(t)
